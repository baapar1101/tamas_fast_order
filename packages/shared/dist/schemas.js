...
export const REQUIRED_PROFILE_FIELDS = ['name', 'lastName', 'storeName', 'address'];
...
export const WAREHOUSES = ['kerman', 'tehran', 'site'];
...
export const SYNC_ENTITIES = ['products', 'categories', 'brands', 'colors', 'users', 'orders', 'settings'];
 ...
 * Uploads
 * ------------------------------------------------------------------ */
export const UPLOAD_KINDS = ['product', 'brand', 'category', 'slide', 'certificate', 'other'];
